...
concatMatrixVector :: Matrix -> Vector -> Matrix
concatMatrixVector [] [] = []
concatMatrixVector [] _  = []
concatMatrixVector _ []  = []
concatMatrixVector (mat:mats) (vec:vecs) = (mat ++ [vec]) : concatMatrixVector mats vecs
...
gaussAlgo :: Matrix -> Vector -> Bool -> CustomAns
gaussAlgo [] vec _ = NotExists
gaussAlgo mat vec paral = checkResult $ findMainPivot (concatMatrixVector mat vec) [] paral
